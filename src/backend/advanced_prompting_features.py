...
class LearningSystem:
    ...
    def record_user_interaction(self, user_id: str, preferences: UserPreferences, 
    ...
    def get_system_insights(self) -> Dict[str, Any]:
        ...
        active_users = len([u for u in self.user_analytics.values() 
    ...
    def _calculate_performance_trend(self) -> str:
        ...
        older_metrics = self.performance_metrics[-20:-10] if len(self.performance_metrics) >= 20 else []
    ...
    def _save_analytics(self):
        ...
        try:
            data = {
                'user_analytics': {uid: asdict(analytics) for uid, analytics in self.user_analytics.items()},
                'preference_patterns': {
    ...
    def generate_prompt(self, user_input: str, context: Dict[str, Any], 
        ...
        try:
            ...
            self.learning_system.record_user_interaction(
                user_id, preferences, response_time, True
            )
...
class PerformanceMonitor:
    ...
    def record_metrics(self, response_time: float, cache_hit_rate: float, 
                      memory_usage: float, cpu_usage: float, error_rate: float):
        """Record performance metrics."""
