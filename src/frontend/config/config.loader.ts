...
export const isDevelopment = () =>
  config.frontend.features.appEnv === 'development';
...
export const getAPIBaseURL = () =>
  `http://${config.backend.server.host}:${config.backend.server.port}`;
export const getBackendURL = () =>
  `http://${config.backend.server.host}:${config.backend.server.port}`;
export const getFrontendURL = () =>
  `http://${config.frontend.server.host}:${config.frontend.server.port}`;
...
export const isBundleAnalyzerEnabled = () =>
  config.frontend.development.bundleAnalyzer;
