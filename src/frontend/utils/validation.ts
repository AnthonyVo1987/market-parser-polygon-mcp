...
export const VALIDATION_ERROR_MESSAGES = {
  ...
  [VALIDATION_ERROR_CODES.INVALID_TICKER]:
...
export function validateField(
  ...
  if (!value.trim()) {
    if (rules.required) {
      return {
        ...
        errorMessage:
          VALIDATION_ERROR_MESSAGES[VALIDATION_ERROR_CODES.REQUIRED],
      };
    }
    return { isValid: true };
  }
  ...
  if (rules.pattern && !rules.pattern.test(value)) {
    return {
      ...
      errorMessage:
        VALIDATION_ERROR_MESSAGES[VALIDATION_ERROR_CODES.INVALID_FORMAT],
    };
  }
...
export function validateEmail(value: string): ValidationResult {
  ...
  if (!EMAIL_PATTERN.test(value)) {
    return {
      ...
      errorMessage:
        VALIDATION_ERROR_MESSAGES[VALIDATION_ERROR_CODES.INVALID_EMAIL],
    };
  }
...
export function validateUrl(value: string): ValidationResult {
  ...
  if (!URL_PATTERN.test(value)) {
    return {
      ...
      errorMessage:
        VALIDATION_ERROR_MESSAGES[VALIDATION_ERROR_CODES.INVALID_URL],
    };
  }
...
export function validateTicker(value: string): ValidationResult {
  ...
  if (!TICKER_PATTERN.test(value)) {
    return {
      ...
      errorMessage:
        VALIDATION_ERROR_MESSAGES[VALIDATION_ERROR_CODES.INVALID_TICKER],
    };
  }
