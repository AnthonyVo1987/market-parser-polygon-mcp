...
# CLI Test Regression Script - NEW 32-Test Suite with Chat History Analysis
# Tests all 32 standardized test prompts sequentially in a SINGLE CLI session
...
# - Multi-Ticker Test Sequence: Tests 27-32 (6 tests)
# Total: 32 tests per loop
#
...
echo -e "${CYAN}🧪 CLI Test Regression - NEW 32 Test Suite${NC}"
echo -e "${CYAN}===========================================${NC}"
...
echo -e "Session Mode: ${GREEN}PERSISTENT${NC} (all 32 tests in same session per loop)"
echo -e "Test Features: ${GREEN}Parallel Tool Calls (max 3)${NC}, ${GREEN}Chat History Analysis${NC}"
echo ""

# The 32 standardized test prompts organized by ticker sequence
declare -a prompts=(
    # SPY Test Sequence (Tests 1-13)
    "Market Status"
    "Current Price: \$SPY"
    ...
    # NVDA Test Sequence (Tests 14-26)
    "Market Status"
    "Current Price: \$NVDA"
    ...
    # Multi-Ticker Test Sequence (Tests 27-32)
    "Market Status"
...
declare -a test_names=(
    ...
    # NVDA Test Sequence (Tests 14-26)
    "Test_14_Market_Status"
    "Test_15_NVDA_Current_Price"
    "Test_16_NVDA_Today_Closing_Price"
    "Test_17_NVDA_Yesterday_Closing_Price"
    "Test_18_NVDA_Last_Week_Performance"
    "Test_19_NVDA_Previous_Week_Friday_Price"
    "Test_20_NVDA_Last_2_Weeks_Daily_Bars"
    "Test_21_NVDA_RSI_14"
    "Test_22_NVDA_MACD"
    "Test_23_NVDA_SMA_20_50_200"
    "Test_24_NVDA_EMA_20_50_200"
    "Test_25_NVDA_Support_Resistance"
    "Test_26_NVDA_Technical_Analysis"
    # Multi-Ticker Test Sequence (Tests 27-32)
    "Test_27_Multi_Market_Status"
    "Test_28_Multi_Current_Price_WDC_AMD_GME"
    "Test_29_Multi_Today_Closing_Price_WDC_AMD_GME"
    "Test_30_Multi_Yesterday_Closing_Price_WDC_AMD_GME"
    "Test_31_Multi_Last_Week_Performance_WDC_AMD_GME"
    "Test_32_Multi_Last_2_Weeks_Daily_Bars_WDC_AMD_GME"
)
...
for loop_num in $(seq 1 $LOOP_COUNT); do
    ...
    echo -e "${CYAN}Session will run all 32 tests sequentially${NC}"
